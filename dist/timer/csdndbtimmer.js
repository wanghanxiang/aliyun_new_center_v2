...
class csdnDbSchedule extends AbstractSchedule_1.AbstractSchedule {
    constructor(scheduleInfo) {
        super(scheduleInfo);
        const { name, corn } = timmer_config_1.TIMMER_CONFIG['csdn-db-task'];
        this.scheduleInfo = {
            corn,
            name,
            switch: true
    ...
    async task() {
        await (0, csdntask_1.csdnTask)('db');
    }
}
exports.default = csdnDbSchedule;
